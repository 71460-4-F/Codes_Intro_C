...
{ // Struct Base de dados
	...
	int quantidade; // quantidade de politicos que foram adicionados pelo usuário
} BaseDados;
...
{ // função para gravar
	...
	{
		fprintf(arq, "%s %s \n", dados.vetor_poli[i].apelido, dados.vetor_poli[i].nomeCompleto);
	}
